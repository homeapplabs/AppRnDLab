...
<body>
<form action="healthCheckUpAcion">
...
<tr>            
<td width="15%" colspan="1" >
<s:text name="Heath Check Up" />
</td>
<td width="15%" colspan="1">
<s:select name="healthCheckUp" list="{'Dentist','Routinal'}" headerKey="0" headerValue="-Select-" emptyOption="false" theme="simple" />
</td>
<td width="20%" colspan="1">
<s:text name="Due Date" />
</td>
<td width="20%" colspan="1">
<s:textfield name="healthcheckUpDueDate" size="10" maxlength="10" theme="simple" />
</td>
<td width="60%" colspan="6">
<s:checkbox name="remindMeHealthCheckUpDueDate" theme="simple" />
...
<s:submit name="addHealthCheckUp" label="Submit" value="Submit" theme="simple"/>
