...
<title>Phone/Mobile Bill</title>
</head>
<body>
<form action="phoneMobileBillAction">
...
<td width="15%" colspan="1">
<s:select name="serviceProvider" list="{'Airtel','BSNL'}" headerKey="0" headerValue="-Select-" 
            emptyOption="false" theme="simple" />
</td>
<td width="15%" colspan="1">
<s:text name="Phone/Mobile Number" />
</td>
<td width="15%" colspan="1">
<s:textfield name="phone_MobileNumber" size="12" theme="simple" />
</td>
<td width="10%" colspan="1">
<s:text name="Total Amount" />
</td>
<td width="10%" colspan="1" >
<s:textfield name="phoneMobileBillTotalAmount" size="10" maxlength="10" theme="simple" />
</td>
</tr>
...
<td width="15%" colspan='1'>
<s:textfield name="phoneMobileServiceProvider" size="10" theme="simple" />
</td>
<td width="10%" colspan="1">
...
<td width="10%" colspan="1">
<s:textfield name="phoneMobileBillDueDate" size="10" maxlength="10" theme="simple" />
</td>
<td width="10%" colspan="4">
<s:checkbox name="remindMePhoneMobileBill" theme="simple" />
<s:text name="Make me Remind" />
</td>
</tr>
<tr>
<td width="100%" colspan="6" align="center">
<s:submit name="addPhoneMobile" label="Submit" value="Submit" theme="simple"/>
