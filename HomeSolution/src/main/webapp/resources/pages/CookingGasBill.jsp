...
<title>Cooking Gas Bill</title>
</head>
<body>
<form action="cookingGasBillAction">
...
<td width="18%" colspan='1'>
<s:select name="supllier" list="{'IGL','BPLC','IOC'}" headerKey="0" headerValue="-Select-" 
...
<td width="15%" colspan='1'>
<s:textfield name="previousReading" size="12" maxlength="12" theme="simple" />
</td>
<td width="17%" colspan='1' >
<s:text name="Current Reading" />
</td>
<td width="17%" colspan='1'>
<s:textfield name="currentReading" size="12" maxlength="12" theme="simple" />
</td>
</tr>
...
<td width="18%" colspan='1'>
<s:textfield name="unitConsumed" size="4" maxlength="4" theme="simple" />
</td>
<td width="15%" colspan="1">
<s:text name="Total Amount" />
</td>
<td width="15%" colspan="1" >
<s:textfield name="cookingGasBillTotalAmount" size="5" maxlength="5" theme="simple" />
</td>
<td width="17%" colspan="1">
<s:text name="Due Date" />
</td>
<td width="17%" colspan="1">
<s:textfield name="cookingGasBillDueDate" size="10" maxlength="10" theme="simple" />
</td>
</tr>
...
<td width="15%" colspan='1'>
<s:textfield name="otherCookingGasSupplier" size="10" theme="simple" />
</td>
<td width="10%" colspan="6">
<s:checkbox name="remindMeCookingGasBill" theme="simple" />
...
<s:submit name="addCookingGas" label="Submit" value="Submit" theme="simple"/>
