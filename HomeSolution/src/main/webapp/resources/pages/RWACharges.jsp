...
<title>RWA Charges</title>
</head>
<body>
<form action="rwaChargesAction">
...
<tr>            
<td width="15%" colspan="1" >
<s:text name="Society Name" />
</td>
<td width="15%" colspan="1">
<s:select name="societyName" list="{'Vardan','Takshiya'}" headerKey="0" headerValue="-Select-" emptyOption="false" theme="simple" />
</td>
<td width="20%" colspan="1">
<s:text name="Total Amount" />
</td>
<td width="20%" colspan="1" >
<s:textfield name="rwaCharges" size="10" maxlength="10" theme="simple" />
</td>
<td width="15%" colspan="1" >
<s:text name="Other" />
</td>
<td width="15%" colspan="1">
<s:textfield name="otherRWACharges" size="10" theme="simple" />
</td>
<tr>
<td width="20%" colspan="1">
...
<td width="20%" colspan="1">
<s:textfield name="rwaChargesDueDate" size="10" maxlength="10" theme="simple" />
</td>
<td width="60%" colspan="6">
<s:checkbox name="remindMeRWAChargesDueDate" theme="simple" />
...
<s:submit name="addRWACharges" label="Submit" value="Submit" theme="simple"/>
