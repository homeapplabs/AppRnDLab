...
<td width="20%" colspan="1" >
<s:textfield name="tutionFees" size="10" maxlength="10" theme="simple" />
</td>
<td width="20%" colspan="1">
<s:text name="Due Date" />
</td>
<td width="20%" colspan="1">
<s:textfield name="tutionFeesDueDate" size="10" maxlength="10" theme="simple" />
</td>
<td width="60%" colspan="6">
<s:checkbox name="remindMeTutionFeesDueDate" theme="simple" />
...
<s:submit name="addTutionFees" label="Submit" value="Submit" theme="simple"/>
